...
class yolov7_model:
	def __init__(self,model_path,img_size = 640,stride = 64,conf_thres = 0.50,iou_thres = 0.45):
		...
		# Carrerando modelo com a metada da precisão
